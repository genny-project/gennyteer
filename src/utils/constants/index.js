...
const GET_NEW_JOBS = '/qwanda/baseentitys/GRP_NEW_ITEMS/linkcodes/LNK_CORE/attributes?pageStart=0&pageSize=1000';
// const GET_TOKEN_URL = 'https://bouncer.outcome-hub.com/auth/realms/internmatch/protocol/openid-connect/token';
const GET_TOKEN_URL = 'http://keycloak.genny.life:8180/auth/realms/genny/protocol/openid-connect/token';
const FETCH_IMAGE = id => `qwanda/baseentitys/${id}/linkcodes/LNK_BEG/attributes`;
...
export { BASE_URL, GET_NEW_JOBS, GET_TOKEN_URL, FETCH_IMAGE, SEARCH_BE, emailSearchJSON};
